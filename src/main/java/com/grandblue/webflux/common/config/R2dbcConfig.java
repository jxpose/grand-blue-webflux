...
import com.grandblue.webflux.common.converter.ByteBufferToUUIDConverter;
...
//        .serverZoneId(ZoneId.systemDefault())
  ...
  public R2dbcCustomConversions r2dbcCustomConversions() {
    return new R2dbcCustomConversions(getStoreConversions(), List.of(new ByteBufferToUUIDConverter()));
  }
}
